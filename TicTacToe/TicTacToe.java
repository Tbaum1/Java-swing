...
public class TicTacToe extends javax.swing.JFrame {
    ...
    private void btnChangePlayersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangePlayersActionPerformed
        if(JOptionPane.showConfirmDialog(null, "Are you sure you want to reset points and change players?", "Warning!!", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            ...
            names.setPlayer1Name(player1Name);
            names.setPlayer2Name(player2Name);
            lblPlayer1Name.setText(String.valueOf(names.getPlayer1Name()));
            lblPlayer2Name.setText(String.valueOf(names.getPlayer2Name()));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        names.setPlayer2Name(player2Name);
        lblPlayer1Name.setText(String.valueOf(names.getPlayer1Name()));
        lblPlayer2Name.setText(String.valueOf(names.getPlayer2Name()));  //when the JFrame for TicTacToe class is opened then it prompts the users to enter their names
